...
public class CardEventRegister implements SocketEventRegister {
    ...
    public void registerEvents(SocketIOServer server) {
        ...
        // actionCardService.useActionCard(request);
        //                        socketIoService.sendBroadCast(request.getRoomId(), "cardUsed",
        // response);
        //                    } catch (BusinessException e) {
        //                        client.sendEvent("errorEvent", new
        // ErrorResponse(e.getErrorCode()));
        //                    }
        //                });
        //
        //        // 2. 도구 수리 카드
